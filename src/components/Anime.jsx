      ...
      <div className="flex-grow">
        ...
        <div className="flex my-20 gap-x-10">
          <div className="ml-40">
            ...
            <div className="mt-5">
              <button
                className="flex items-center mb-5 justify-center text-white bg-blue-600 transition hover:bg-blue-700 px-[61px] py-2 rounded-md"
                onClick={toggleModal}
              >
          ...
          <div>
            <ul className="flex gap-x-5">
              {animeInfo.genres?.map((genre, index) => (
                <li
                  key={genre.mal_id}
                  className="px-3 py-1 bg-blue-800 bg-opacity-30 text-blue-500 text-[12px] rounded-xl font-bold"
                >
                  {genre.name}
                </li>
              ))}
            </ul>
            <h1 className="text-white max-w-[700px] mt-2 font-medium text-[40px]">
              {animeInfo.title} ({animeInfo.type})
            </h1>
            <h2 className="text-white font-normal max-w-[700px] text-[20px]">
            ...
            <div className="mr-40">
              ...
              <button
                className="text-white mt-3 p-3 bg-zinc-800 hover:bg-zinc-700 transition rounded-lg font-bold"
                onClick={toggleReadMore}
              >
                {isExpanded ? "Read Less" : "Read More"}
              </button>
            </div>
            <h1 className="text-zinc-100 mt-7 font-normal text-2xl">
              Characters:
            </h1>
                ...
                <li key={character.character.mal_id} className="text-white">
                  <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-medium  text-blue-500 max-w-[200px] text-[20px]">
                        {character.character.name}
                      </span>
                      <span className="font-normal text-zinc-200 text-[13px]">
                        {character.role}
                      </span>
                    </div>
                  </div>
            ...
            <h1 className="text-zinc-100 mt-5 font-normal text-2xl">
              Streaming on:
            </h1>
