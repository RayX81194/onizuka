      ...
      <div className="flex-grow">
        ...
        <div className="flex my-20 gap-x-5 sm:gap-x-7">
          <div className="ml-4 sm:ml-6 md:ml-10 lg:ml-24 xl:ml-40">
            ...
            <div className="mt-5">
              <button
                className="flex items-center mb-5 justify-center text-white bg-blue-600 transition hover:bg-blue-700 px-[16px] xs:px-[26px] sm:px-[61px] py-2 rounded-md"
                onClick={toggleModal}
              >
          ...
          <div>
            <ul className="flex flex-wrap gap-x-5">
              {animeInfo.genres?.map((genre, index) => (
                <li
                  key={genre.mal_id}
                  className="px-3 py-1 bg-blue-800 mt-3 bg-opacity-30 text-blue-500 text-[12px] rounded-xl font-bold"
                >
                  {genre.name}
                </li>
              ))}
